    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "role",
                columns: new[] { "id", "created_at", "is_deleted", "role_name", "role_type", "updated_at" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Utc), false, "Admin", 1, new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Utc), false, "Client", 2, new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
