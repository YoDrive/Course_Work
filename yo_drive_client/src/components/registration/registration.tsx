            ...
            <div className={styles.content}>
                <div className={styles.registrationForm}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div style={{height: 13}}>
                            {errors?.lastName && <p className={styles.itemError}>{errors?.root?.message||"*Поле обязательно к заполнению"}</p>}
                        </div>
                        <label className={styles.registrationItem}>
                            Имя
                        ...
                        <div style={{height: 13}}>
                            {errors?.firstName && <p className={styles.itemError}>{errors?.root?.message||"*Поле обязательно к заполнению"}</p>}
                        </div>
                        <label className={styles.registrationItem}>
                            Отчество
                        ...
                        <div style={{height: 13}}>
                            {errors?.patronymic && <p className={styles.itemError}>{errors?.root?.message||"*Поле обязательно к заполнению"}</p>}
                        </div>
                        <label className={styles.registrationItem}>
                            E-mail
